...
if nvpcase=="MMP": # modfied midpoint for solving psimp, hmp, varphimp= fd.split(result_mixedmp)
    ...
    # https://fenics2021.com/talks/brubeck.html p multigrid https://arxiv.org/pdf/2107.14758.pdf
    ...
    param_psi1 = {'ksp_converged_reason':None, 'ksp_type': 'cg', 'pc_type': 'ilu'} # 1 iteration
    ...
    h_exprnl = fd.NonlinearVariationalSolver(fd.NonlinearVariationalProblem(h_exprnl1,h_new), solver_parameters=param_psi4)
...
if nic=="SP3" and ntflag==0 and ntflag2==0:
    ...
    filEtaMax = "resultsntflag0/potflow3dperetamax.txt"
    # PETSc.Sys.Print
...
outputEtamax = open(fileEtaMax,"w")
...
while t <= 1.0*(t_end + dt): #  t_end + dt
    ...
    if t>=0.0:
        if nic==SP1 or nic==SP2 or nic==SP3:
            ...
            print("%.11f %.11f %.11f %.11f" % (t, wtamax),file=outputEtaMax)
