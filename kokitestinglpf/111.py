...
if nvpcase==111: # ONNO 19-12: above case 11 but with combo step for steps 1 and 2 solved in tandem? As test for nonlinear case 2?
    ...
    # phi_combo = fd.NonlinearVariationalSolver(fd.NonlinearVariationalProblem(Fexpr, result_mixed, bcs = [BC_exclude_beyond_surface, BC_varphi]))
