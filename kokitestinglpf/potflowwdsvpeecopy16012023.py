...
Lx = 140
Lz = 1
nx = 200 #  Works for SV at 200, 400, 800 CFL = 0.125; works not well for SE; 
nz = 6
...
nvpcase = 23 # case 111 (SE linear), 2 (SE nonlinear), 21 (SE nonlinear wavemaker), 22 (SV nonlinear wavemaker) work and
# case 23 (midpoint NL wavemaker) 
...
if nvpcase == 21: # wavemaker
    nic = 1
if nvpcase == 22: # wavemaker
    nic = 1
if nvpcase == 23: # wavemaker
    nic = 1
if nvpcase == 24: # wavemaker
    nic = 1
...
if nic == 0:
    ...
    # ONNO 15-01: dangerous change (?) commented out: omega = np.sqrt(gg*H0)*2.0*np.pi/lambd 
...
elif nvpcase==23: # Steps 1 and 2 need solving in unison; mid point
    # 
    # Desired VP format of the above
    param_psi    = {'ksp_type': 'preonly', 'pc_type': 'lu'}
    # 
