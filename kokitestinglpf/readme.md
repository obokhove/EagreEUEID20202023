...
$$+\int_0^{L_x}  -g H_0 W^{n+1/2} h^n (\frac 12 h^n-H_0) + H_0 W^{n+1/2}  \phi^{n+1}|_{z=H_{0}} \frac {(h^{n+1}-h^n)}{\Delta t}  + H_0 W^{n+1/2}  \phi^{n}|_{z=H_{0}} \frac {h^n}{\Delta t}  -H_0(x-L_w) R_t^{n+1/2} h_x^{n}  d x$$
