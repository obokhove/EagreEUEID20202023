...
data_path3 = adata_path+'data/MMP/TC1_2D_series2(1ele,phiGLL)/Nx200_nz32_2dtf'
data_path4 = adata_path+'data/MMP/TC1_2D_series2(1ele,phiGLL)/Nx100_nz32_2dtf'
data_path5 = adata_path+'data/MMP/TC1_2D_series2(1ele,phiGLL)/Nx50_nz32_2dtf'
...
for t in t_plot:
	...
	if one_point:
		col = 'blue'
		plt.loglog(dx,L2,  color=col, marker='^',label=r'$L^2$')
	else:
