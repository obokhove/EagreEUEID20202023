...
plt.plot(tt1,AA,label=r'$CG2/\Delta x/\Delta t$', linewidth='10')
plt.plot(tt14cg,AA4cg,label=r'$CG4/2\Delta x/\Delta t$', linewidth='6')
plt.plot(tt110multi,AA10multi,'--',label=r'$CG2/\frac{\Delta x}{2}/\Delta t$', linewidth='4')
plt.plot(tt1200ndt,AA200ndt,'--',label=r'$CG2/\Delta x/\frac{\Delta t}{2}$', linewidth='4')
...
plt.ylabel( r'$A (m)$ ',size=16)
plt.grid()

plt.ticklabel_format(style='sci', axis='y', scilimits=(0,0)) 
plt.savefig('A_TC5.eps')
plt.show(block=True)
